...
import { Home, Dog, Calendar, User, LogOut } from 'lucide-react';
...
export function OwnerLayout({ children }: OwnerLayoutProps) {
  ...
  const navItems = [
    { path: '/owner', icon: Home, label: 'Übersicht' },
    { path: '/owner/walks', icon: Calendar, label: 'Meine Walks' },
    { path: '/owner/profile', icon: User, label: 'Profil' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-dark">Dogwalking</h1>
            </div>
